...
GLTexture ImageLoader::loadPNG(std::string filePath)
{
    ...
    GLContextManager::getGLContext()->bindTexture(GL_TEXTURE_2D, texture.id);
    // Upload the pixels to the texture
    glTexImage2D(GL_TEXTURE_2D, (GLint)0, GL_RGBA, (GLsizei)width, (GLsizei)height, (GLint)0, GL_RGBA, GL_UNSIGNED_BYTE,
        &(out[0]));
