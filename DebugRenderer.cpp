...
GLEngine::DebugRenderer::DebugRenderer() {
    // Empty
}
...
void GLEngine::DebugRenderer::init() {
...
void GLEngine::DebugRenderer::end() {
    glBindBuffer(GL_ARRAY_BUFFER, m_vbo);
    // Orphan the buffer
...
void GLEngine::DebugRenderer::drawLine(const glm::vec2& a, const glm::vec2& b, const ColourRGBA8& color) {
    int i = m_verts.size();
...
void GLEngine::DebugRenderer::drawBox(const glm::vec4& destRect, const ColourRGBA8& color, float angle) {
...
void GLEngine::DebugRenderer::drawCircle(const glm::vec2& center, const ColourRGBA8& color, float radius) {
...
void GLEngine::DebugRenderer::render(const glm::mat4& projectionMatrix, float lineWidth) {
    m_program.use();
...
void GLEngine::DebugRenderer::dispose() {
    if (m_vao) {
